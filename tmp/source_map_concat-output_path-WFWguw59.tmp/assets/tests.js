...
define('blogs/tests/controllers/application.jshint.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('blogs/tests/integration/components/post-object-test.jshint.lint-test', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | integration/components/post-object-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/post-object-test.js should pass jshint.');
  });
});
...
define('blogs/tests/integration/components/top-menu-test.jshint.lint-test', ['exports'], function (exports) {
  'use strict';
