...
define("blogs/templates/components/select-user", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Ipx56K5n", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"btn-group\"],[\"static-attr\",\"data-toggle\",\"buttons\"],[\"flush-element\"],[\"text\",\"\\n\\n\"],[\"block\",[\"radio-button\"],null,[[\"value\",\"groupValue\",\"changed\"],[\"user1\",[\"get\",[\"usern\"]],[\"helper\",[\"action\"],[[\"get\",[null]],\"userSelected\"],null]]],2],[\"text\",\"\\n\"],[\"block\",[\"radio-button\"],null,[[\"value\",\"groupValue\",\"changed\"],[\"user2\",[\"get\",[\"usern\"]],[\"helper\",[\"action\"],[[\"get\",[null]],\"userSelected\"],null]]],1],[\"text\",\"\\n\"],[\"block\",[\"radio-button\"],null,[[\"value\",\"groupValue\",\"changed\"],[\"user3\",[\"get\",[\"usern\"]],[\"helper\",[\"action\"],[[\"get\",[null]],\"userSelected\"],null]]],0],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\" \\t User3\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t User2\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t  User1\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "blogs/templates/components/select-user.hbs" } });
});
define("blogs/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "eLzY89Cd", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row justify-content-md-center\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-12 col-md-auto\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"h1\",[]],[\"flush-element\"],[\"text\",\"Блоги\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-12 col-md-auto\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"append\",[\"unknown\",[\"select-user\"]],false],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"blog.create\"],[[\"class\"],[\"btn btn-warning\"]],4],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-12\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,3],[\"text\",\"\\t\\t\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Удалить блог\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Редактировать блог\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Перейти в блог\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-block\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t    \"],[\"open-element\",\"h4\",[]],[\"static-attr\",\"class\",\"card-title\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"blog\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t    \"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"card-text\"],[\"flush-element\"],[\"text\",\"Создано пользователем:\"],[\"append\",[\"unknown\",[\"blog\",\"createdBy\"]],false],[\"text\",\" \"],[\"append\",[\"unknown\",[\"blog\",\"dateCreated\"]],false],[\"text\",\".\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t    \"],[\"block\",[\"link-to\"],[\"blog\",[\"get\",[\"blog\"]],[\"helper\",[\"query-params\"],null,[[\"blogId\"],[[\"get\",[\"blog\",\"id\"]]]]]],[[\"class\"],[\"btn btn-primary\"]],2],[\"text\",\"\\n\\t\\t\\t    \"],[\"block\",[\"link-to\"],[\"blog.edit\",[\"get\",[\"blog\"]]],[[\"class\"],[\"btn btn-success\"]],1],[\"text\",\"\\n\\t\\t\\t    \"],[\"block\",[\"link-to\"],[\"blog.delete\",[\"get\",[\"blog\"]]],[[\"class\"],[\"btn btn-danger\"]],0],[\"text\",\"\\n\\t\\t\\t  \"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"blog\"]},{\"statements\":[[\"text\",\"Создать блог\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "blogs/templates/index.hbs" } });
});
...
define("blogs/templates/post/delete", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "YLgWM0dH", "block": "{\"statements\":[[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Удалить данную запись?\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-danger\"],[\"dynamic-attr\",\"onclick\",[\"helper\",[\"action\"],[[\"get\",[null]],\"delete\"],null],null],[\"flush-element\"],[\"text\",\"Удалить блог\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "blogs/templates/post/delete.hbs" } });
});
